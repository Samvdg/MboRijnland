...
class ProductController extends AbstractController
{
     ...
     */
    public function addToCart(Request $request, Product $product, ProductRepository $productRepository): Response
    {
        $cart = $productRepository->fillDetails($product);
        return $this->render('product/index.html.twig', [
            'products' => $productRepository->findAll(),
    ...
    // public function fillDetails($product, ProductRepository $productRepository): array
    // {
    ...
    //     foreach($ids as $item){
    //         $currentProduct = $productRepository->find($item["id"]);
    //         $cart[$item["id"]] = array(
    //             "id" => $item["id"],
